...
export const RUNTIME_COMMAND_CONTRACTS = {
  ...
  UPLOAD_CHAT_IMAGE: command('payload-delegated', 'status-or-domain-error', 'background-error', 'live-only'),
  ...
  GET_CHAT_CATALOG: command('none', 'status', 'background-error', 'live-only'),
  SET_ACTIVE_CHAT_MODEL: command('payload-cast', 'status-or-domain-error', 'background-error', 'live-only'),
  GET_CURSOR_BRIDGE_STATUS: command('none', 'status', 'background-error', 'live-only'),
