...
export const RUNTIME_COMMAND_CONTRACTS = {
  ...
  UPLOAD_CHAT_IMAGE: typedCommand('payload-decoded', 'status-or-domain-error', 'background-error', 'live-only'),
  ...
  GET_CHAT_CATALOG: typedCommand('none', 'status', 'background-error', 'live-only'),
  SET_ACTIVE_CHAT_MODEL: typedCommand('payload-decoded', 'status-or-domain-error', 'background-error', 'live-only'),
  GET_CURSOR_BRIDGE_STATUS: typedCommand('none', 'status', 'background-error', 'live-only'),
