...
export const zhCN = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      descriptionDensityDescription: '控制设置页在密集控制行里显示多少辅助说明。',
    ...
    chatPage: {
      ...
      modeDetailWeb: '使用已登录的网页标签页，并保持同会话连续性。',
      ...
      startersLabel: '建议起手 Prompt',
      starterDebug: '调试页面',
      starterSummarize: '总结选区',
      starterPlan: '规划工作',
      starterDebugPrompt: '检查我当前的设置，告诉我哪里需要注意、哪里已经就绪，以及下一步具体动作。',
      starterSummarizePrompt: '把选中或粘贴的上下文总结成决策、待处理事项和下一步动作。',
      starterPlanPrompt: '把这个粗略目标转换成实施计划，包括风险、测试和最小可用补丁。',
    ...
    automationPage: {
      ...
      commandCenter: {
        ...
        blocked: '阻塞',
        running: '运行中',
        launcherTitle: '运行指挥中心',
        launcherDescription: '先描述目标和范围，再用修复与验证长循环启动；完整工作流和高级字段仍在下方。',
        primary: '主路径',
        ...
        proofSummary: '默认带 run-state、proof-ledger、defect-log、verification-matrix、coverage-summary 和 final handoff。',
      },
