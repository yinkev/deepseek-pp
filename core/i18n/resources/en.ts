...
export const en = {
  ...
  app: {
    ...
    context: {
      ...
      sessionTitle: 'Session strategy: {value}',
      memory: 'Memory',
      memoryOn: 'On',
      memoryOff: 'Off',
  ...
  sidepanel: {
    ...
    settings: {
      ...
      descriptionDensityDescription: 'Control how much helper text Settings shows in dense control rows.',
    ...
    chatPage: {
      ...
      modeDetailWeb: 'Uses the logged-in DeepSeek tab and keeps same-session continuity.',
      ...
      startersLabel: 'Suggested starter prompts',
      starterDebug: 'Debug page',
      starterSummarize: 'Summarize selection',
      starterPlan: 'Plan work',
      starterDebugPrompt: 'Inspect my current setup and tell me what needs attention, what is ready, and the next concrete action.',
      starterSummarizePrompt: 'Summarize the selected or pasted context into decisions, open items, and next actions.',
      starterPlanPrompt: 'Turn this rough objective into an implementation plan with risks, tests, and the smallest useful next patch.',
      keyboardHint: 'Enter sends · Shift Enter newline',
    ...
    automationPage: {
      ...
      commandCenter: {
        ...
        blocked: 'Blocked',
        running: 'Running',
        launcherTitle: 'Run Command Center',
        launcherDescription: 'Describe the goal and scope, then start the repair-and-verification long loop; full workflows and advanced fields remain below.',
        primary: 'Primary path',
        objectiveLabel: 'Goal, scope, or failure',
        objectivePlaceholder: 'Goal, scope, or failure',
        startLongLoop: 'Start long loop',
        timeout: 'Timeout',
        ...
        proofSummary: 'Defaults include run-state, proof-ledger, defect-log, verification-matrix, coverage-summary, and final handoff.',
      },
