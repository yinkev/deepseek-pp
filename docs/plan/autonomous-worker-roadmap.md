...
- Files: `core/run/review-scheduler.ts`, `core/run/review-lane-gate.ts`, `core/run/worker-prompt.ts`, `core/run/store.ts`, `core/run/orchestrator.ts`, `core/pet/orchestrator-bridge.ts`, `tests/run-review-scheduler.test.ts`, `tests/run-worker-prompt.test.ts`, `tests/run-review-lane-store.test.ts`, `tests/run-orchestrator.test.ts`, `tests/pet-orchestrator-bridge.test.ts`, plus `docs/plan/autonomous-review-dispatch-contract.md`.
