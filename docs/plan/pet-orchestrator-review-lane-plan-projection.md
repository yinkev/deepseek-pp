...
| 4 | Raw or malformed plan fields do not leak into pet snapshot or capsule | malformed object and primitive-plan tests cover sanitized projection and raw-value omission | covered |
