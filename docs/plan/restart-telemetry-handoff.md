...
| Preserve writer completion semantics for the real restart telemetry package shape. | `does not write a completion marker when real handoff file write fails` |
